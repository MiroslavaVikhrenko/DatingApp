...
namespace API.Controllers
{
        ...
        IPhotoService photoService) : BaseApiController
    {
        ...
        public async Task<ActionResult> UpdateMember(MemberUpdateDto memberUpdateDto)
        {
            ...
            if (await uow.Complete()) return NoContent(); // 204 response for put request
        ...
        public async Task<ActionResult<Photo>> AddPhoto([FromForm] IFormFile file)
        {
            ...
            if (result.Error != null) return BadRequest(result.Error.Message); //comes from Cloudinary
        ...
        public async Task<ActionResult> SetMainPhoto(int photoId)
        {
            ...
            // make sure they do not set an existing main image as their new main image
        ...
        public async Task<ActionResult> DeletePhoto(int photoId)
        {
            ...
            if (photo == null || photo.Url == member.ImageUrl) // don't allow deleteing main photo, need to re-select main photo first
            {
            ...
            if (photo.PublicId != null)
            {
                ...
                if (result.Error != null) return BadRequest(result.Error.Message); // from cloudinary
            }
